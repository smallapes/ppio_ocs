...
3、问题集问答：如果用户输入是一个问题，又不涉及具体设备id（例如 4d62ee0501bbd8d96f9c6d857c3e2737), 且与问题集中的某个问题完全匹配，用户需求才属于问题集问答。
问题集：
{qs}

4、文档问答：如果用户输入是一个问题，又不涉及具体设备id（例如 4d62ee0501bbd8d96f9c6d857c3e2737), 且无法在上述问题集中找到，但与以下文档集中的内容高度相关则用户需求属于文档问答。
文档集：
{ds}
